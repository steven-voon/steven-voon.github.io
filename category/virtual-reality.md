    ...
    <section id="one" class="spotlights">
        ...
        <section>
            ...
            <div class="content">
                <div class="inner">
                    <header class="major">
                        <h3>Mental Healthness & Public Awareness</h3>
                    </header>
                    <p>Developed for the university. A digital twin experiment that allows students to conduct complex lab work in a safe, repeatable virtual environment.</p>
                    <div class="featured-links">
                        <span class="label">Featured Projects:</span>
                        <div class="link-group">
