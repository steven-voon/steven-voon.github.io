...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2.5rem; align-items: start; margin-bottom: 3rem;">   
    <div>
        ...
        <p><strong>Into the Metaverse</strong> is an XR art showcase featuring immersive VR works by Penang street artists Taz and Fakh, presented within a custom digital world developed during a two-week residency.</p> 
