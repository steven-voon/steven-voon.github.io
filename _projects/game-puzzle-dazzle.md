...
hardware: "Mobile"
technologies: ["Unity"]
project_url: "https://play.google.com/store/apps/details?id=com.creatinnotech.PuzzleDazzle" # Referral link
video_id: "https://www.youtube.com/watch?v=CwW3UkOL9Oc"
---
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2.5rem; align-items: start; margin-bottom: 3rem;">   
    <div>
        ...
        <p><strong>Puzzle Dazzle</strong> is an AR extension of a physical puzzle experience, allowing users to dive into virtual underwater spaces to discover treasure and learn about marine life.</p> 
        <p>As <strong> Unity XR Engineer</strong>, developed immersive underwater landscapes, interactive treasure hunt games, and marine learning experiences.</p>     
    </div>
    {% if page.video_id %}
