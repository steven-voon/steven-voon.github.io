...
project_url: "https://www.avventura.co/over-the-rainbow" # Referral link
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2.5rem; align-items: start; margin-bottom: 3rem;">   
    <div>
        ...
        <p><strong>Over the Rainbow</strong> is a multi-sensory VR experience that immerses participants in a vibrant virtual world with uplifting visuals, calming music, and playful interactions.</p> 
        <p>As <strong> Unity XR Engineer</strong>, developed the VR stage with integrated MOCAP-driven characters, implemented interactive gameplay, and ensured seamless player performance.</p>     
    </div>
    {% if page.video_id %}
