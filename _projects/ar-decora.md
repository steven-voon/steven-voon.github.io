...
project_url: "https://play.google.com/store/apps/details?id=com.creatinno.decora" # Referral link
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2.5rem; align-items: start; margin-bottom: 3rem;">   
    <div>
        ...
        <p><strong>DECORA</strong> is an AR application that allows users to preview furniture in their own space virtually before making a purchase.</p> 
        <p>As <strong>Technical Lead cum Startup Founder</strong>, pitched the DECORA AR app to investors, conducted financial due diligence, and led prototype development.</p>     
    </div>
    {% if page.video_id %}
