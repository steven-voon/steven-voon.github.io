...
project_url: "https://www.instagram.com/p/C4aIW9uLPxd/" # Referral link
carousel_images: 
  - "/assets/images/gots-ss0.png"
  - "/assets/images/gots-ss1.png"
  - "/assets/images/gots-ss2.png"
  - "/assets/images/gots-ss3.png"
  - "/assets/images/gots-ss4.png"
  - "/assets/images/gots-ss5.png"
  - "/assets/images/gots-ss6.png"
  - "/assets/images/gots-ss7.png"
  - "/assets/images/gots-ss8.png"
  - "/assets/images/gots-ss9.png"
  - "/assets/images/gots-ss10.png"
  - "/assets/images/gots-ss11.png"
  - "/assets/images/gots-ss12.png"
  - "/assets/images/gots-ss13.png"
  - "/assets/images/gots-ss14.png"
---
...
<div class="project-specs" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 1rem; background: rgba(155, 241, 255, 0.05); padding: 1.5rem; border-left: 4px solid #9bf1ff; margin-top: -2.5rem; margin-bottom: 2rem; border-radius: 0 8px 8px 0;">
    ...
    <div><strong style="font-size: 0.7rem; letter-spacing: 1px;">PRODUCER'S SAY</strong><br><a href="{{ page.project_url }}" target="_blank" class="button small primary">See it Now ↗</a></div>
</div>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2.5rem; align-items: start; margin-bottom: 3rem;">   
    <div>
        ...
        <p><strong>Guardian of the Sea</strong> is a VR diving simulation that uses digital art to raise awareness about marine biodiversity and ocean conservation.</p> 
        <p>As <strong>Unity XR Engineer</strong>, collaborated with producers to provide technical guidance on creative concepts and develop immersive VR experiences. For accessibility, a Mac and a Window version of the VR game is build.</p>     
    </div>
