...
project_url: "https://www.linkedin.com/posts/mark-smith-286b49a_musicnt-in-partnership-with-peta-khan-from-activity-7287263661021188096-NUbm/" # Referral link
carousel_images: 
  - "/assets/images/musicNT-ss1.png"
  - "/assets/images/musicNT-ss2.png"
  - "/assets/images/musicNT-ss3.png"
  - "/assets/images/musicNT-ss4.png"
  - "/assets/images/musicNT-ss5.png"
  - "/assets/images/musicNT-ss6.png"
  - "/assets/images/musicNT-ss7.png"
  - "/assets/images/musicNT-ss8.png"
---
...
<div class="project-specs" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 1rem; background: rgba(155, 241, 255, 0.05); padding: 1.5rem; border-left: 4px solid #9bf1ff; margin-top: -2.5rem; margin-bottom: 2rem; border-radius: 0 8px 8px 0;">
    ...
    <div><strong style="font-size: 0.7rem; letter-spacing: 1px;">DIRECTOR'S SAY</strong><br><a href="{{ page.project_url }}" target="_blank" class="button small primary">See it Now ↗</a></div>
</div>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2.5rem; align-items: start; margin-bottom: 3rem;">   
    <div>
        ...
        <p><strong>Music NT Artist VR Platform</strong> is a VR initiative that showcases Northern Territory artists in immersive virtual worlds, enabling global audience reach without the need for travel.</p> 
        <p>As <strong>Unity XR Engineer</strong>, designed and build unique VR spaces for each featured music piece, provided technical guidance, and developed immersive experiences.</p>     
    </div>
