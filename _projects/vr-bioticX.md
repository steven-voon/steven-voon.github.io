...
project_url: "https://www.maitreehouse.com/work/bioticx" # Referral link
carousel_images: 
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2.5rem; align-items: start; margin-bottom: 3rem;">   
    <div>
        ...
        <p><strong>Biotic X</strong> is a VR theatre experience that explores environmental challenges and collective action through immersive parallel virtual realities.</p> 
        <p>As <strong>Unity XR Engineer</strong>, collaborated with producers to develop a Beat Saber–style VR storytelling experience.</p>     
    </div>
