...
project_url: "https://brownsmart.com.au/tour/" # Referral link
carousel_images: 
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2.5rem; align-items: start; margin-bottom: 3rem;">   
    <div>
        ...
        <p><strong>Welcome to Brown's Mart</strong> is an AR app that lets visitors explore the venue’s history through interactive displays, archival images, and community stories.</p> 
        <p>As <strong>Unity XR Engineer</strong>, collaborated with producers to provide technical guidance on marker design, develop the AR experience, and manage app publishing and maintenance.</p>     
    </div>
