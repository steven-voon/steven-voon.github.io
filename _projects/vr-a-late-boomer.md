...
project_url: "https://www.annalouisepaul.com/blog/2022/10/18/a-late-bloomer" # Referral link
carousel_images: 
  - "/assets/images/alateboomer-ss1.jpg"
  - "/assets/images/alateboomer-ss2jpg"
  - "/assets/images/alateboomer-ss3.jpg"
  - "/assets/images/alateboomer-ss4.jpg"
  - "/assets/images/alateboomer-ss5.jpg"
  - "/assets/images/alateboomer-ss6.jpg"
  - "/assets/images/alateboomer-ss7.jpg"
  - "/assets/images/alateboomer-ss8.jpg"
  - "/assets/images/alateboomer-ss9.jpg"
  - "/assets/images/alateboomer-ss10.jpg"
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2.5rem; align-items: start; margin-bottom: 3rem;">   
    <div>
        ...
        <p><strong>A Late Bloomer</strong> is a hybrid dance and VR project exploring memory, heritage, and identity, to reflect on how cultural stories endure or fade.</p> 
        <p>As <strong>Unity XR Engineer</strong>, collaborated with producers to explore VR concepts and develop a proof-of-concept immersive experience.</p>     
    </div>
